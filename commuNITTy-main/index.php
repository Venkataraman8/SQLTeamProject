                ...
                <div class="dropdown-menu" aria-labelledby="dropdown01">
                    ...
                    if($res05) {
                        while ($rowa = mysqli_fetch_array($res05)) {
                            ...
                            if ($rowa['status'] == 'unread' and $rowa['ty'] == 'Messaged you') {

                                echo '<a  style=" font-weight:bold; border-bottom: 1px;" class="dropdown-item" href="messaging.php?username=' . $rowa['sender'] . '">';
                                echo"<small>";
                                echo $rowa['dat'];
                                echo "</small><br>";
                                echo $rowa['sender'];
...
<div id="left" style="font-size: 25px;"><h3><?php echo "Welcome to CommuNITTy: $name <br> You are Logged in. <br>  "?></h3></div>
<br><br>
...
{
    echo '<div align="center" style="font-size: 20px;">Advertisement</div>';
    if(!$result1)
    ...
    while($row=mysqli_fetch_array($result1))
    {
        echo '   <div align="center">
                <div class="card text-center" style="width: 300px; border-style: solid; background: rgb(242,241,250);
                background: linear-gradient(90deg, rgba(242,241,250,1) 0%, rgba(199,199,255,1) 53%, rgba(149,165,244,1) 100%);">
                <div class="card-header">
                Featured:  '.$row['keyword'].'
                </div>
                <div class="card-body">
                 <h5 class="card-title"><a style="color: black">'.$row['ad_title'].'</a></h5>
                 <h6 class="card-title"><a style="color: black">'.$row['ad_desc'].'</a></h6>
                 <h7><b>Posted by: </b>'.$row['username'].' </h7><br>
                 <a type="button" class="btn btn-primary" href="profile.php?username='.$row['username'].'">Contact Personal</a>
...
{
    echo '<div align="center" style="font-size: 20px;"> &nbsp; &nbsp; Questions in NewsFeed</div>';
    if(!$result)
        echo mysqli_error($connect);
    ...
    while($row=mysqli_fetch_array($result))
    {
        echo '   <div align="center">
                ...
                <div class="card-body">
                 ...
                 <h6><b>Question posted by: </b>'.$row['username'].' </h6>
